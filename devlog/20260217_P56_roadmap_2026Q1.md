...
```
독립 작업 (병렬 가능)
├── A-1. Auto-Discovery Detail View     ✅ 완료
├── A-2. Manifest Validator             ✅ 완료
├── A-3. Manifest Schema 정규화         ✅ 완료
└── C-1. PyInstaller 빌드 검증          ✅ 완료

순차 작업
B-1. Taxonomic Opinions PoC             ✅ 완료
  └── B-2. 56개 Uncertain Family 확장   [중규모, 다음 작업]
...
| 순서 | 항목 | 상태 |
|------|------|------|
| 1 | A-2 Manifest Validator | ✅ 완료 |
| 2 | A-1 Auto-Discovery | ✅ 완료 |
| 3 | A-3 Manifest 정규화 | ✅ 완료 |
| 4 | C-1 PyInstaller 검증 | ✅ 완료 |
| 5 | B-1 Opinions PoC | ✅ 완료 |
| 6 | B-2 Uncertain Family 확장 | 다음 |

#!/usr/bin/env python3
"""Build mollusca DB from Treatise molluscan source files.

Two classification profiles:
  Profile 1: Treatise 1957-1971 (original) — ammonoidea_1957 + mollusca_1960 +
              cephalopoda_1964 + bivalvia_1969_vol1/vol2 + bivalvia_1971_vol3
  Profile 2: Treatise Supplements 1989-1996 — mollusca_scaphopoda_1989 +
              ammonoidea_1996

Profile 2 supplements cover specific groups (Scaphopoda revision + Cretaceous
Ammonoidea revision). They don't replace all of Profile 1's data.

Pure source-driven build (no canonical DB dependency).

Usage:
    python scripts/build_mollusca_db.py [--version 0.1.0]
"""
...
PROFILES = [
    {
        "name": "Treatise 1957-1971",
        "description": (
            "Treatise on Invertebrate Paleontology, Parts I/K/L/N, "
            "Mollusca (1957-1971)"
        ),
        "sources": [
            "treatise_ammonoidea_1957.txt",
            "treatise_mollusca_1960.txt",
            "treatise_cephalopoda_1964.txt",
            "treatise_bivalvia_1969_vol1.txt",
            "treatise_bivalvia_1969_vol2.txt",
            "treatise_bivalvia_1971_vol3.txt",
        ],
        "reference": {
            "authors": (
                "MOORE, R.C., TEICHERT, C., COX, L.R., NEWELL, N.D., "
                "KNIGHT, J.B., ARKELL, W.J. & others"
            ),
            "year": 1957,
            "title": (
                "Treatise on Invertebrate Paleontology, Parts I/K/L/N, "
            ...
            "raw_entry": (
                "Moore, R.C., Teichert, C., Cox, L.R., Newell, N.D., "
                "Knight, J.B., Arkell, W.J. & others, 1957-1971. "
                "Treatise on Invertebrate Paleontology, Parts I, K, L, N, "
                "Mollusca 1-6."
            ),
        },
    ...
    {
        "name": "Treatise Supplements 1989-1996",
        "description": (
            "Treatise on Invertebrate Paleontology, Mollusca Supplements: "
            "Part I Revised (Scaphopoda, 1989) & Part L Revised Vol. 4 "
            "(Cretaceous Ammonoidea, 1996)"
        ),
        "sources": [
            "treatise_mollusca_scaphopoda_1989.txt",
            "treatise_ammonoidea_1996.txt",
        ],
        "reference": {
            "authors": (
                "MOORE, R.C., TEICHERT, C. (eds.), WRIGHT, C.W., "
                "CALLOMON, J.H. & HOWARTH, M.K."
            ),
            "year": 1989,
            "title": (
                "Treatise on Invertebrate Paleontology, Part I Revised "
                "(Mollusca 1, 1989) & Part L Revised Vol. 4 "
                "(Cretaceous Ammonoidea, 1996)"
            ),
            "publisher": (
                "Geological Society of America & University of Kansas Press"
            ...
            "reference_type": "book",
            "raw_entry": (
                "Moore, R.C. & Teichert, C. (eds.), 1989. Part I Revised, "
                "Mollusca 1. Wright, C.W. with Callomon, J.H. & Howarth, "
                "M.K., 1996. Part L Revised, Vol. 4: Cretaceous Ammonoidea. "
...
RANK_ORDER = {
    ...
    "Class": 0, "Subclass": 1, "Order": 2, "Suborder": 3,
    "Superfamily": 4, "Family": 5, "Subfamily": 6, "Genus": 7,
}
    ...
    return {
        ...
        "views": {
            "taxonomy_tree": {
                ...
                "display": "tree",
                "title": "Taxonomy",
                "description": "Molluscan hierarchical classification (Treatise 1957-1971 & Supplements 1989-1996)",
            ...
            "genera_table": {
                "type": "table",
                "title": "Genera",
                "description": "Flat list of all molluscan genera",
            ...
            "tree_chart": {
                ...
                "display": "tree_chart",
                "title": "Tree",
                "description": "Molluscan taxonomy tree -- radial or rectangular layout",
                "icon": "bi-diagram-3",
...
def write_scoda_metadata(cur, version, ref_id):
    ...
    """)
    metadata = {
        "artifact_id": "mollusca",
        "name": "Mollusca",
        "version": version,
        "description": (
            "Molluscan genus-level taxonomy from the Treatise "
            "(1957-1971 & Supplements 1989-1996)"
        ),
        "license": "CC-BY-4.0",
        "schema_version": "1.0",
        "created_at": now,
    ...
    """, (
        "publication",
        "Moore, R.C., Teichert, C. et al., 1957-1971. "
        "Treatise on Invertebrate Paleontology, Parts I, K, L, N, "
        "Mollusca 1-6. Geological Society of America & University of Kansas.",
        "Gastropoda, Scaphopoda, Amphineura, Monoplacophora, Cephalopoda "
        "(Nautiloidea, Ammonoidea, Bactritoidea), and Bivalvia. "
    ...
    """)
    descs = [
        ("taxon", None, "Molluscan taxa from Phylum to Genus"),
        ("taxon", "rank", "Taxonomic rank: Phylum, Class, Subclass, Order, Suborder, Superfamily, Family, Subfamily, Genus"),
    ...
    """, (json.dumps([
        ...
        {"name": "rank", "type": "select", "required": True, "label": "Rank",
         "options": ["Phylum", "Class", "Subclass", "Order", "Suborder",
                     "Superfamily", "Family", "Subfamily", "Genus"]},
...
def main():
    parser = argparse.ArgumentParser(description='Build mollusca DB from source')
    parser.add_argument('--version', default=VERSION, help=f'Version (default: {VERSION})')
    args = parser.parse_args()

    version = args.version
    dst_path = DST_DIR / f"mollusca-{version}.db"
    ...
    print(f"Building mollusca v{version}")
    ...
    for pi, profile in enumerate(PROFILES, 1):
        ...
        # Bridge orphan roots to Phylum MOLLUSCA
        phylum_id = resolve_taxon("Mollusca", "Phylum", conn, taxon_index, new_taxa_cache)
        taxon_index.update(new_taxa_cache)
        ...
        if orphan_roots:
            ...
            """, bridge_edges)
            conn.commit()
            print(f"  Bridge edges to Phylum Mollusca: {len(bridge_edges)}")
            for oid, oname, orank in orphan_roots:
                print(f"    {orank} {oname} -> Phylum Mollusca")

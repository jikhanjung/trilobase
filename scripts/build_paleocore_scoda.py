...
Usage:
  python scripts/build_paleocore_scoda.py              # create paleocore.scoda
  python scripts/build_paleocore_scoda.py --dry-run    # preview manifest without creating file
  python scripts/build_paleocore_scoda.py --output out.scoda  # custom output path
"""

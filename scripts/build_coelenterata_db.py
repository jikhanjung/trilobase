#!/usr/bin/env python3
"""Build coelenterata DB from Treatise coelenterate source file.

One classification profile:
  Profile 1: Treatise 1956

Pure source-driven build (no canonical DB dependency).

Usage:
    python scripts/build_coelenterata_db.py [--version 0.1.0]
"""
...
PROFILES = [
    {
        "name": "Treatise 1956",
        "description": "Treatise on Invertebrate Paleontology, Part F, Coelenterata (1956)",
        "sources": [
            "treatise_coelenterata_1956.txt",
        ],
        "reference": {
            "authors": "MOORE, R.C. (ed.), BAYER, F.M., BOSCHMA, H., HARRINGTON, H.J., HILL, D., HYMAN, L.H., LECOMPTE, M., MONTANARO-GALLITELLI, E., STUMM, E.C. & WELLS, J.W.",
            "year": 1956,
            "title": "Treatise on Invertebrate Paleontology, Part F, Coelenterata",
            "publisher": "Geological Society of America & University of Kansas Press",
            "reference_type": "book",
            "raw_entry": (
                "Moore, R.C. (ed.), et al., 1956. Treatise on Invertebrate Paleontology, "
    ...
    return {
        ...
        "views": {
            "taxonomy_tree": {
                ...
                "display": "tree",
                "title": "Taxonomy",
                "description": "Coelenterate hierarchical classification (Treatise 1956)",
            ...
            "genera_table": {
                "type": "table",
                "title": "Genera",
                "description": "Flat list of all coelenterate genera",
            ...
            "tree_chart": {
                ...
                "display": "tree_chart",
                "title": "Tree",
                "description": "Coelenterate taxonomy tree -- radial or rectangular layout",
                "icon": "bi-diagram-3",
...
def write_scoda_metadata(cur, version, ref_id):
    ...
    """)
    metadata = {
        "artifact_id": "coelenterata",
        "name": "Coelenterata",
        "version": version,
        "description": "Coelenterate genus-level taxonomy from the Treatise (1956)",
        "license": "CC-BY-4.0",
        "schema_version": "1.0",
        "created_at": now,
    }
    ...
    """, (
        ...
        "Part F, Coelenterata. Geological Society of America and University of "
        "Kansas Press, 498 p.",
        "Protomedusae, Dipleurozoa, Scyphozoa, Hydrozoa, Anthozoa. "
    ...
    """)
    descs = [
        ("taxon", None, "Coelenterate taxa from Class to Genus"),
        ("taxon", "rank", "Taxonomic rank: Class, Subclass, Order, Suborder, Superfamily, Family, Subfamily, Genus"),
    ...
    cur.execute(
        ...
        ("Coelenterata default UI manifest",
    ...
    """, (json.dumps([
        ...
        {"name": "rank", "type": "select", "required": True, "label": "Rank",
         "options": ["Class", "Subclass", "Order", "Suborder",
                     "Superfamily", "Family", "Subfamily", "Genus"]},
...
def main():
    parser = argparse.ArgumentParser(description='Build coelenterata DB from source')
    parser.add_argument('--version', default=VERSION, help=f'Version (default: {VERSION})')
    args = parser.parse_args()

    version = args.version
    dst_path = DST_DIR / f"coelenterata-{version}.db"
    ...
    print(f"Building coelenterata v{version}")

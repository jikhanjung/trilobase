#!/usr/bin/env python3
"""Build porifera DB from Treatise porifera/archaeocyatha source files.

Two classification profiles:
  Profile 1: Treatise 1955 (original) — archaeocyatha + porifera combined
  Profile 2: Treatise Revised 1972-2015 — archaeocyatha revised + porifera vols 2-5

Pure source-driven build (no canonical DB dependency).

Usage:
    python scripts/build_porifera_db.py [--version 0.1.0]
"""
...
PROFILES = [
    {
        "name": "Treatise 1955",
        "description": "Treatise on Invertebrate Paleontology, Part E, Archaeocyatha and Porifera (1955)",
        "sources": [
            "treatise_archaeocyatha_porifera_1955.txt",
        ],
        "reference": {
            "authors": "DE LAUBENFELS, M.W., OKULITCH, V.J. & others",
            "year": 1955,
            "title": "Treatise on Invertebrate Paleontology, Part E, Archaeocyatha and Porifera",
            "publisher": "Geological Society of America & University of Kansas Press",
            "reference_type": "book",
            "raw_entry": (
                "Moore, R.C. (ed.), 1955. Treatise on Invertebrate Paleontology, "
                "Part E: Archaeocyatha and Porifera. Geological Society of America "
                "and University of Kansas Press."
            ),
        },
    },
    {
        "name": "Treatise Revised 1972-2015",
        "description": "Treatise on Invertebrate Paleontology, Part E (Revised), Archaeocyatha (1972) & Porifera (2003-2015)",
        "sources": [
            "treatise_archaeocyatha_revised_1972.txt",
            "treatise_porifera_revised_2003_vol2.txt",
            "treatise_porifera_revised_2004_vol3.txt",
            "treatise_porifera_revised_2015_vol4.txt",
            "treatise_porifera_revised_2015_vol5.txt",
        ],
        "reference": {
            "authors": "HILL, D., FINKS, R.M., RIGBY, J.K., DEBRENNE, F., WEBBY, B.D. & others",
            "year": 1972,
            "title": "Treatise on Invertebrate Paleontology, Part E (Revised), Archaeocyatha & Porifera, Volumes 1-5",
            "publisher": "Geological Society of America & University of Kansas",
            "reference_type": "book",
            "raw_entry": (
                "Hill, D. (ed.), 1972; Kaesler, R.L. (ed.), 2003-2004; "
                "Selden, P.A. (ed.), 2015. Treatise on Invertebrate Paleontology, "
                "Part E (Revised), Archaeocyatha (Vol. 1) & Porifera (Vols. 2-5)."
            ),
        },
    },
]
    ...
    return {
        ...
        "views": {
            "taxonomy_tree": {
                ...
                "display": "tree",
                "title": "Taxonomy",
                "description": "Porifera & Archaeocyatha hierarchical classification (Treatise 1955 & Revised 1972-2015)",
            ...
            "genera_table": {
                "type": "table",
                "title": "Genera",
                "description": "Flat list of all poriferan and archaeocyathan genera",
            ...
            "tree_chart": {
                ...
                "display": "tree_chart",
                "title": "Tree",
                "description": "Porifera & Archaeocyatha taxonomy tree -- radial or rectangular layout",
                "icon": "bi-diagram-3",
...
def write_scoda_metadata(cur, version, ref_id):
    ...
    """)
    metadata = {
        "artifact_id": "porifera",
        "name": "Porifera",
        "version": version,
        "description": "Porifera & Archaeocyatha genus-level taxonomy from the Treatise (1955 & Revised 1972-2015)",
        "license": "CC-BY-4.0",
        "schema_version": "1.0",
        "created_at": now,
    }
    ...
    """, (
        ...
        "Part E: Archaeocyatha and Porifera. Geological Society of America "
        "and University of Kansas Press.",
        "Archaeocyatha (Okulitch) and Porifera (de Laubenfels). "
    ...
    """, (
        ...
        "Selden, P.A. (ed.), 2015. Treatise on Invertebrate Paleontology, "
        "Part E (Revised), Archaeocyatha (Vol. 1) & Porifera (Vols. 2-5).",
        "Revised classification: Archaeocyatha (Hill, 1972), "
        "Demospongea/Hexactinellida/Heteractinida/Calcarea (Finks, Rigby et al., 2003-2004), "
        "Hypercalcified Porifera/Stromatoporoidea (Debrenne, Webby et al., 2015).",
    ))
    ...
    """)
    descs = [
        ("taxon", None, "Porifera & Archaeocyatha taxa from Phylum to Genus"),
...
def main():
    parser = argparse.ArgumentParser(description='Build porifera DB from source')
    parser.add_argument('--version', default=VERSION, help=f'Version (default: {VERSION})')
    args = parser.parse_args()

    version = args.version
    dst_path = DST_DIR / f"porifera-{version}.db"
    ...
    print(f"Building porifera v{version}")
    ...
    for pi, profile in enumerate(PROFILES, 1):
        ...
        # Bridge orphan roots: the 1955 source has two top-level phyla
        # (Archaeocyatha and Porifera). No single root bridge needed --
        # they remain as separate roots in the tree.
        # For revised profiles, similarly keep Phylum-level roots as-is.

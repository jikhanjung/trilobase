# Trilobase 프로젝트 History

완료된 작업의 상세 기록. 현재 상태와 남은 작업은 [HANDOFF.md](HANDOFF.md) 참조.

---

## Phase 1~12: 데이터 파이프라인 (줄 정리 → Bibliography)
...
## Phase 13~24: SCODA 구현 (메타데이터 → GUI)
...
## Phase 25~38: 패키지 + PaleoCore (ZIP → 리브랜딩)
...
## Phase 39~46: 범용 뷰어 (Manifest → Runtime Purification)
